  ...
  var w = (function () {
      ...
      return (
        ...
        (t.code = function (e) {
          ...
          if (e)
            return (
              ...
              { type: 'code', raw: e[0], codeBlockStyle: 'indented', text: this.options.pedantic ? t : E(t, '\n') }
            )
        }),
        (t.fences = function (e) {
          var t,
            ...
            for (
              ...
              if (
                ...
                this.options.pedantic
                  ? ((i = 2), (c = a.trimLeft()))
                  : ((i = t[2].search(/[^ ]/)), (c = a.slice((i = 4 < i ? 1 : i))), (i += t[1].length)),
                (s = !1),
        ...
        (t.autolink = function (e, t) {
          ...
          if (e)
            return (
              (t = '@' === e[2] ? 'mailto:' + (u = c(this.options.mangle ? t(e[1]) : e[1])) : (u = c(e[1]))),
  ...
  var z = (function () {
      function u(e) {
        ...
        this.options.pedantic
          ...
          : this.options.gfm && ((e.block = y.gfm), this.options.breaks ? (e.inline = v.breaks) : (e.inline = v.gfm)),
            ...
            if (
              ...
              if ((u = this.tokenizer.escape(r))) (r = r.substring(u.raw.length)), t.push(u)
                ...
                (r = r.substring(u.raw.length)),
                  ...
                  (s = !0),
                  (e = t[t.length - 1]) && 'text' === e.type ? ((e.raw += u.raw), (e.text += u.text)) : t.push(u)
              else if (r) {
      ...
      return (
        (t.code = function (e, t, u) {
          ...
          return (
            ...
            (e = e.replace(/\n$/, '') + '\n'),
            t
              ? '<pre><code class="' + this.options.langPrefix + c(t) + '">' + (u ? e : c(e, !0)) + '</code></pre>\n'
                ...
                case 'table':
                  ...
                  for (D += this.renderer.tablerow(l), a = '', r = o.rows.length, u = 0; u < r; u++) {
                    for (l = '', i = (s = o.rows[u]).length, n = 0; n < i; n++)
                      l += this.renderer.tablecell(this.parseInline(s[n].tokens), { header: !1, align: o.align[n] })
